 ...
 */
final class Version20220203141728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart_item CHANGE quantity qty INT NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE cart_item CHANGE product product VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE qty quantity INT NOT NULL');
